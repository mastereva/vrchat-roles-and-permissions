...
public class ColliderAnimationBool : UdonSharpBehaviour
{
    ...
    public void TurnOn()
    {
        foreach (GameObject arrayGameObject in gameObjectsWithAnimators)
        {
            if (arrayGameObject != null && arrayGameObject.name != "ToDestroy")
            {
                ...
                if (animator != null)
                {
                    animator.SetBool(animationParameterName, onEnterValue);
                }
            }
        }
    }
    ...
    public void TurnOff()
    {
        foreach (GameObject arrayGameObject in gameObjectsWithAnimators)
        {
            if (arrayGameObject != null && arrayGameObject.name != "ToDestroy")
            {
                ...
                if (animator != null)
                {
                    animator.SetBool(animationParameterName, onExitValue);
                }
            }
        }
    }
